...
Public Class ctrReportMonth
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.ctrReportMonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrReportMonth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrReportMonth = New ctrReportMonth()
        rpt.Site = Me.Site
        Return rpt
    End Function
