...
Public Class ctrPurchase1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.ctrPurchase1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrPurchase1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrPurchase1 = New ctrPurchase1()
        rpt.Site = Me.Site
        Return rpt
    End Function
