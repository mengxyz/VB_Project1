...
Public Class ctrReportRecive
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.ctrReportRecive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrReportRecive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrReportRecive = New ctrReportRecive()
        rpt.Site = Me.Site
        Return rpt
    End Function
