...
Public Class ctrLowAmount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.ctrLowAmount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrLowAmount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrLowAmount = New ctrLowAmount()
        rpt.Site = Me.Site
        Return rpt
    End Function
