...
Public Class ctrPurchase
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.ctrPurchase.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrPurchase
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrPurchase = New ctrPurchase()
        rpt.Site = Me.Site
        Return rpt
    End Function
