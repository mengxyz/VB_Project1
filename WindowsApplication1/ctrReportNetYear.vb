...
Public Class ctrReportNetYear
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.ctrReportNetYear.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrReportNetYear
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrReportNetYear = New ctrReportNetYear()
        rpt.Site = Me.Site
        Return rpt
    End Function
