...
Public Class ctrReportPurchase
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.ctrReportPurchase.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedctrReportPurchase
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctrReportPurchase = New ctrReportPurchase()
        rpt.Site = Me.Site
        Return rpt
    End Function
